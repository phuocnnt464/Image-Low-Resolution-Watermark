 ...
 * @param {string}    bitDepth          - '8bit'|'12bit'|'24bit'|'32bit'|'64bit'
 */
const processImages = async (files, resolutionPreset = 'FHD', watermarkFile = null, watermarkPosition = 'bottom-left', bitDepth = '8bit') => {
