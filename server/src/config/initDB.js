  ...
  try {
    ...
    await pool.query(`
      CREATE TABLE IF NOT EXISTS image_processing_history (
        ...
        scale_percent      INTEGER DEFAULT NULL,
        resolution_preset  VARCHAR(20) DEFAULT 'FHD',
    ...
    await pool.query(`
      ALTER TABLE image_processing_history
        ADD COLUMN IF NOT EXISTS resolution_preset VARCHAR(20) DEFAULT 'FHD';
    `);
